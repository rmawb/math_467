...
def gauss_legendre4(f, a, b, n):
    """
    Approximates the integral of a function using 4-point gaussian-legendre rule
    ...
    #Hard-coded abscissa and weights
    absc = [-0.861136, -0.339981, 0.339981, 0.861136]
...
def integral_solve(f, a, b, n):
    ...
    quad.append(gauss_legendre4(f, a, b, n))
    return quad
...
names = ['Left Reimann sum', 'Right Reimann sum', 'Midpoint Reimann sum',\
         'Trapezoidal rule', '2-point gauss', '3-point gauss', '4-point gauss']
